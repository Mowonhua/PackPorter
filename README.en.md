...
Build and run from source. The instructions below target **Windows** and require Rust/Cargo, a linker for your Rust toolchain, and Windows resource compilation tools.
